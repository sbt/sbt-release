...
Yes, and as a start, let's take a look at the [default definition](https://github.com/sbt/sbt-release/blob/v1.5.0/src/main/scala/ReleasePlugin.scala#L273-L285) of `releaseProcess`:
