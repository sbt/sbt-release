...
Yes, and as a start, let's take a look at the [default definition](https://github.com/sbt/sbt-release/blob/v1.0.6/src/main/scala/ReleasePlugin.scala#L240) of `releaseProcess`:
